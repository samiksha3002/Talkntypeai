...
import { ChevronLeft, HelpCircle, User, Phone, Mail, FileText, Save } from 'lucide-react';
...
const AddInquiryPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Inquiry Details Submitted:", inquiryDetails);
    
    // In a real application, this would save the lead/inquiry data.
    alert(`New Inquiry from ${inquiryDetails.inquirerName} saved!`);
    
    // Clear the form and navigate back
    setInquiryDetails({ inquirerName: '', contactNumber: '', email: '', typeOfCase: '', summary: '', followUpDate: '' });
    navigate('/'); 
  };
      ...
      <form onSubmit={handleSubmit} className="p-4 space-y-6">
        ...
        <div className="bg-slate-800 p-4 rounded-xl border border-slate-700">
            ...
            <div className="space-y-4">
                {/* Name */}
                <div>
                    <label htmlFor="inquirerName" className="block text-sm font-medium text-slate-300 mb-1">
                        Name
                    </label>
                    <input
                        type="text"
        ...
        <div className="bg-slate-800 p-4 rounded-xl border border-slate-700">
            ...
            <div className="space-y-4">
                {/* Type of Case */}
                <div>
                    <label htmlFor="typeOfCase" className="block text-sm font-medium text-slate-300 mb-1">
        ...
        <button
          type="submit"
          className="w-full flex items-center justify-center py-3 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-xl shadow-lg transition duration-200 active:scale-98"
        >
