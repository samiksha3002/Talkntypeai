    ...
    <footer className="bg-slate-900 text-slate-300 py-12 px-6 border-t border-slate-800">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-white text-lg tracking-wide">SUPER STENO</span>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <SocialIcon path="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 2a2 2 0 11-1.998 2.002 2 2 0 011.998-2.002z" /> {/* LinkedIn */}
            </div>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} SuperSteno. All rights reserved.</p>
