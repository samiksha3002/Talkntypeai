export const convertToKrutiDev = (sourceText) => {
    ...
    // STEP 0: Pre-Processing (Add these)
text = text.replace(/<\/p>/g, "\n"); // Paragraph khatam hone par nayi line
text = text.replace(/<br\s*\/?>/g, "\n"); // <br> ko asli New Line mein badlo
text = text.replace(/<[^>]+>/g, ""); // Baaki saare HTML tags hata do
text = text.replace(/&nbsp;/g, " "); 
text = text.replace(/\u00A0/g, " ");
// Taaki spaces preserve rahein
    ...
    // -----------------------------------------------------------
    text = text.replace(/श्वा/g, "Üok"); // Shwa + aa matra
